...
for line in lines:
    ...
    elif "ALL_PUBLIC_METHODS: ClassVar[list[str]] =" in line:
        new_lines.append(line.replace("ALL_PUBLIC_METHODS: ClassVar[list[str]] =", "ALL_PUBLIC_METHODS: typing.ClassVar[list[str]] ="))
